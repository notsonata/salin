...
- Pass an optional mounted `cookies.txt` file to `yt-dlp`, stage it into a writable temp file, enable a Deno-backed JS challenge runtime, and force the Android YouTube client for current Droplet bot-check recovery
